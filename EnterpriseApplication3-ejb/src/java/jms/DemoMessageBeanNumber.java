...
public class DemoMessageBeanNumber implements MessageListener {
    ...
    @PostConstruct
    public void init() {
        log = Logger.getLogger("MessagerNumber");
        log.log(Level.INFO, "MDB DemoMessageBeanNumber created ({0})...", hashCode());
    }
    ...
    public void onMessage(Message message) {
        try {
            ...
            if (message instanceof ObjectMessage) {
                ...
                Integer text = (Integer) msg.getObject();
